# Vioneta alarm card <!-- omit in TOC -->
...
![alt text](https://github.com/Vioneta/vioneta-alarm-card/blob/main/screenshots/alarmo-card.gif?raw=true "demonstration video")
...
1. Click the Orange + button bottom right and search for Alarm Card
2. Click on "Install" under the new card that just popped up.

Note: Ensure to install [`https://github.com/Vioneta/vioneta-alarm-integration`](https://github.com/Vioneta/vioneta-alarm-integration) and add the integration in order for the card to work properly.

Manual installation

1. Download the latest release of `alarmo-card.js` [here](https://github.com/Vioneta/vioneta-alarm-card/releases) and place it into `www/alarmo-card`.
...
Updating via VPS:
VPS should auto-remind you in the VPS tab when an update is available.
